...
recurrence_over_time = df.groupby('Time')['Recurrence'].mean()
recurrence_over_time.plot(kind='line')
plt.xlabel('Time')
plt.ylabel('Proportion of patients with recurrence')
plt.title('Recurrence over Time')
plt.show()
